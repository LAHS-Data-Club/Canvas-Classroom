...
import { oauth2Client, CLASSROOM_SCOPES } from "../config/classroomConfig.js";
import { asyncHandler } from '../helper/helper.js';
import url from 'url';
export const authRouter = Router();
// TODO: test trying to throw an error
// TODO: rest >post?
authRouter.get('/api/classroom/login', asyncHandler(async (req, res) => {
...
authRouter.get('/api/oauth/token', asyncHandler(async (req, res) => {
...
// TODO: ehh
authRouter.get('/api/canvas/auth', asyncHandler(async (req, res) => {
    res.json(!!req.cookies.canvas_token);
}));
authRouter.get('/api/classroom/auth', asyncHandler(async (req, res) => {
