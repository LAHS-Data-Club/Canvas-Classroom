// import { useIsRestoring, useQueries, useQuery, useQueryClient } from "@tanstack/react-query";
...
// // using parallel fetches forward starting from startingPage
// export function useAssignmentsSimpleWithQueries(
//   courseId: string, 
//   enabled: boolean
// ) {
//   // TODO: kinda unoptimal but it COULD work what matters ig...
